...
<script src="<c:url value="/js/editInfo.js"/>"></script>
<style>
@import url("<c:url value="/css/editInfo.css"/>")
</style>
</head>
...
<div id="top" class="navbar navbar-fixed-top">
	<div id="goback" class="navbar-brand">
   	...
   	<div id="title" class="navbar-brand">개인정보수정</div> 
</div> 

<div id="body" class="container-fluid">
	<form role="form" action="JoinSuccess.html" method="post">
		<div class="form-group">
			<input type="text" class="form-control" id="id" maxlength="12" placeholder="아이디" value="${ user.id }" required>
		...
		<div class="form-group">
			<input type="text" class="form-control" id="username" maxlength="30" placeholder="이름" value="${ user.userName }" required>
		...
		<div class="form-group">
			<input type="number" class="form-control" id="phoneNum" placeholder="휴대폰번호" value="${ user.phoneNum }" required>
